...
const EditDealContextMenu = dynamic(
  () => import("@/feature/deals/ui/Modals/EditDealContextMenu"),
  {
    ssr: false,
  },
);

const DelDealContextMenu = dynamic(
  () => import("@/feature/deals/ui/Modals/DelDealContextMenu"),
  {
    ssr: false,
  },
);

const ModalDealInfo = dynamic(
  () => import("@/feature/deals/ui/Modals/ModalDealInfo"),
  {
    ssr: false,
  },
);

const ColorPickerDeal = dynamic(
  () => import("@/feature/deals/ui/Modals/ColorPickerDeal"),
  {
    ssr: false,
  },
);
...
const ActiveModalDeal = ({
  ...
  setOpenedModal: React.Dispatch<
    React.SetStateAction<"edit" | "delete" | "more" | "color" | null>
  >;
}) => (
  <EntityActionModal
    openedModal={openedModal}
