...
import {
  MainWrapperRoute,
  ModalContentRoute,
  OverlayIntersectionRoute,
} from "@/shared/custom-components/ui/IntersectionWrapper"
import { useTypedParams } from "@/shared/hooks/useTypedParams"
import Loading from "./loading"

const ProjectItemInfo = dynamic(() => import("@/feature/deals/ui/ProjectInfo"), {
  ssr: false,
})
...
const DealPageInfo = () => {
  ...
  return (
    <MainWrapperRoute>
      ...
      <ModalContentRoute>{renderDealInfoByType(dealType)}</ModalContentRoute>
    </MainWrapperRoute>
  )
}
