...
import type { BaseDeal, ProjectResponse, RetailResponse } from "@/entities/deal/types"
...
const DealsTabContent = (props: DealsTabContentProps) => {
  ...
  return (
    <DealTableTemplate>
      <DataTable
        columns={columns as ColumnDef<BaseDeal>[]}
        data={deals as BaseDeal[]}
        dealType={dealType}
