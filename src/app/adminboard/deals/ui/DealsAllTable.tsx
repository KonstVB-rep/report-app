...
const DealsAllTable = ({
  table, rows, virtualItems, totalSize,
  openFullInfoCell, setOpenFullInfoCell,
  tableContainerRef
}:{
  ...
  return (
    <div className="rounded-lg relative h-full overflow-auto max-h-[78vh] border transition-all duration-200" ref={tableContainerRef}>
      <TableTemplate table={table} className="rounded-ee-md" totalSize={totalSize}>
        <VirtualRow
          rows={rows}
