...
>(({ className, ...props }, ref) => {
  return <CommandList className={cn("max-h-[unset] px-0 py-1", className)} ref={ref} {...props} />
})
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <PopoverPrimitive.Portal forceMount>
      ...
      >
        <Command
          className={cn("max-h-96 w-full min-w-(--radix-select-trigger-width) px-1", className)}
  ...
  (
    ...
    return (
      <CommandItem
        {...props}
        className={cn(
          disabled && "cursor-not-allowed text-neutral-500 dark:text-neutral-400",
          className,
        )}
        disabled={disabled}
