...
> | null>(null as unknown as DataTableFiltersContextType<Record<string, unknown>>)
...
>() => {
  const context = useContext(
    DataTableFiltersContext as React.Context<DataTableFiltersContextType<TData, TValue>>,
  )

  if (!context) {
    throw new Error("useDataTableFiltersContext  must be used within a DataTableFiltersContext")
  }
  return context
}
