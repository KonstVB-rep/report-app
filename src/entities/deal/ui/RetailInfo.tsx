     ...
     <section className="grid p-4">
       ...
       <div className="grid-container gap-2 py-2">
         <div className="border p-4 rounded-md">
           ...
           <p>
             Название сделки:{" "}{project?.nameDeal}
           </p>
           <p>Тип сделки: {DealTypeLabels[project?.type as keyof typeof DealTypeLabels] || "Нет данных"}</p>
         </div>
         <div className="border p-4 rounded-md">
           <p>Направление: {DirectionProjectLabels[project?.direction as keyof typeof DirectionProjectLabels] || "Нет данных"}</p>
           <p>Тип поставки: {DeliveryProjectLabels[project?.deliveryType as keyof typeof DeliveryProjectLabels] || "Нет данных"}</p>
         </div>
         <div className="border p-4 rounded-md">
         ...
         <div className="border p-4 rounded-md">
           ...
           <p>Дополнительный контакт: {project.additionalContact || "Нет данных"}</p>
         </div>
       </div>
       <div className="border p-4 rounded-md">
