...
import { useDelProject, useGetProjectById } from "@/entities/deal/hooks";
...
const DelProject = ({
  ...
  const { data: project } = useGetProjectById(id, type);
  const { mutate: delProject, isPending } = useDelProject(close, type);
